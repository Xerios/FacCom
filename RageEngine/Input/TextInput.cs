...
namespace RageEngine.Input
{
    ...
    public class TextInput : IDisposable
    {
            ...
            if (nCode == 0 && wParam == 1) {
                ...
                switch ((WindowMessage)msg.Msg) {
                    case WindowMessage.WM_CHAR:
                        if (last_WParam == (char)msg.WParam) {
                            last_WParam = (char)0;
                            break;
                        } else {
                            last_WParam = (char)msg.WParam;
                            this.OnKeyPress(new KeyPressEventArgs((char)msg.WParam));
                        }
                        if (this.RawMessage !=null) this.RawMessage((int)msg.Msg, (int)msg.WParam, (int)msg.LParam);
                        break;
        ...
        public Action<int,int,int> RawMessage;
        ...
        protected virtual void OnKeyPress(KeyPressEventArgs e)
        {
            ...
            if (e.KeyChar.GetHashCode().ToString() == "524296") {
                ...
                if (e.KeyChar>=32) buffer += e.KeyChar;
            }
        }
